...
// Slides are stored on local disk (server/uploads/lectures/) and re-parsed
// on demand rather than caching extracted text in the DB — schema.sql only
// has slides_url, not a text column, and re-parsing a slide deck is cheap.
